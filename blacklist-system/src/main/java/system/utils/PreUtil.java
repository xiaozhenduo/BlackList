...
public class PreUtil {
    ...
    public static List<MenuTreeVO> buildMenus(List<Menu> sysMenuList) {
        List<MenuTreeVO> list = new LinkedList<>();

        sysMenuList.forEach(sysMenu -> {
                    if (sysMenu != null) {
                        List<Menu> menuDTOList = sysMenu.getChildren();
                        ...
                        if (menuDTOList != null && menuDTOList.size() != 0 && sysMenu.getType().equals("0")) {
     ...
     * @param menuType
     */
    public static void findChildren(List<Menu> menuList, List<Menu> menus, int menuType) {
        for (Menu sysMenu : menuList) {
            ...
            for (Menu menu : menus) {
                ...
                if (sysMenu.getId() != null && sysMenu.getId().equals(menu.getParentId().toString())) {
    ...
    *//**
     ...
     * @return
     */
    public static boolean exists(List<Menu> sysMenus, Menu sysMenu) {
        boolean exist = false;
